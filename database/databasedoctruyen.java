...
//bien luu cau lenh tao bang tai khoan
    private String SQLQuery = "CREATE TABLE "+ TABLE_TAIKHOAN +" ( "+ID_TAI_KHOAN+" INTEGER PRIMARY KEY AUTOINCREMENT, "
            ...
            +EMAIL+" TEXT, "
            + PHAN_QUYEN+" INTEGER) ";
//bien luu cau lenh tao bang truyen
...
//insert du lieu vao bang tai khoan
   //chu y phan quyen: 1.admin va 2.user
...
//thuc hien cac cau lenh truy van khong tra ve ket qua
        db.execSQL(SQLQuery);
